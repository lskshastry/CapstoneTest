...
class Behavior(FlaskForm):
    description = TextAreaField('Describe what you did--what you said, or how you acted--that contributed to this situation being a mostly positive situation for you.')
